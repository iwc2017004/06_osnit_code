...
#     print("Names -------------->",data[n]["name"])
#     print("errors ------------>",data[n]["errors"])
#     print("report ------------>", data[n]["report"])
#     print("-------------------------------------------------------------")
...
for n in range(number):
    ...
    try:
        if(data[n].get("name", None) == "VirusTotal_v2_Get_Observable"):
            needed_data["VirusTotal_v2_Get_Observable"] = {"Errors" : data[n].get("errors", None), "Total":data[n]["report"].get("total", None),"Positives" : data[n]["report"].get("positives", None),"URL":data[n]["report"].get("permalink", None)}
