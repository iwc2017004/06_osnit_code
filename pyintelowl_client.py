...
def get_reports_from_intelowl_server(file_path,api_token_file,url):
    ...
    try:
        ...
        md5 = "28851b55864034cba79a0522a17bfc7a"
        ...
        if not analysis_available:
            ...
            api_request_result = pyintelowl_client.send_observable_analysis_request("hash", None,
                                                                                    md5.lower(), False,
                                                                                    False, False,
                                                                                    True, None)
            errors = api_request_result.get('errors', [])
...
if __name__ == "__main__":
    get_reports_from_intelowl_server(r'/home/ubuntu/Desktop/samples/Git.exe',r'api_token.txt','http://10.10.106.101')